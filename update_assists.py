...
print("[+] This programme updates the number of assists a player has [+]\n")
print("[+] Type and enter 'end' or 'stop' to end programme [+]")
player_name = input("[+] Which player made an assist? ")
...
while player_name != "end":
    for rowNum in range(2, int(General_Info_sheet.max_row)+1):
        ...
        if name_cell.title() == player_name.title():
            Goal_Involvement_sheet["D" + str(rowNum)].value += 1
            print("[+] Assists updated successfully [+]\n")
